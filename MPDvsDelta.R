...
# %%% Demonstration using fungal dataset-----
# Read in and clean up fungal community abundances
...
# Build fungal phylogeny
fung.phylo <- read.tree("/home/akoontz11/OTU_Phylogeny/Microbial_Dataset/phylos/fungal/RAxML_bestTree.repCRfung_Feb28_phy")
...
deltas <- seq(0.1,3,by=0.1)
# Test method (using older version that includes plotting functions)
